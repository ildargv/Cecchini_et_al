...
#3.remove duplicates and anything <18nt
...
module load bowtie/1.3.1
for i in $(find . -name "*.bed2.rpm.2555.new"); do bsub "awk '(length(\$1)>25)&&(\$80>1){max1=0; max1n=0; for (i=8;i<=39;i++){if ((\$i+\$(i+38))>max1){max1=(\$i+\$(i+38)); max1n=i+16}};len[\$1]=max1n; ab[\$1]=\$80}END{for (i in ab){print \">\"i\";\"ab[i]\";\"len[i]; print i}}' $i > $i.fa; bowtie -f -v 0 -k 5 mm10.pipipes $i.fa | awk '{print \$3\"\\t\"\$4\"\\t\"(\$4+length(\$5))\"\\t\"\$1\"\\t\"\$7+1\"\\t\"\$2}' > $i.bowtie; awk 'BEGIN{FS=OFS=\"\\t\"}(FNR==NR){places[\$4]++}(FNR<NR){\$5=places[\$4];if(printed[\$4]==\"\"){print;printed[\$4]=1}}' $i.bowtie $i.bowtie > $i.25.all1.realbed2;  rm $i.fa $i.bowtie"; done
...
#10a.merge wt, p9, p17, p9p17, p6 genotypes
...
#line2-start
#line3-end
#line4-mean ab in wildtype
#line5-wt abundance for each replicate
#line6-strand
#line7-all seq and max length
#line8-p9 mean abundance
#line9-p17 mean abundance
#line10-p9p17 mean abundance
#line11-p6 mean abundance
#line12-cluster
#line13-GENE
#line14-TE
#line15-TE strand

#11d.get piRNAs that are undetectable in mutants to identify pi9, pi17, p6-dependent
...
#11e.convert merged.all1.piRNAs.cl.g.r and into the 12.inter.2555.1ppm.realbed.piRNAs format
...
#line2-start
#line3-end
#line4-seq (25nt prefix)
#line5-mean wt abundance
#line6-strand
#line7-cluster
#line8-gene
#line9-TE
#line10-TE strand
#line11-p9 mean abundance
#line12-p17 mean abundance
#line13-p9p17 mean abundance
#line14-p6 mean abundance
